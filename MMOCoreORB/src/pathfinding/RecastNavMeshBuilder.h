...
public:
	...
	RecastNavMeshBuilder(Vector<Reference<MeshData*> > meshData, Zone* zone, String name);
	RecastNavMeshBuilder(Vector<Reference<MeshData*> > meshData, Zone* zone, String name, dtNavMesh *mesh);
