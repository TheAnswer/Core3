...
RecastNavMeshBuilder::RecastNavMeshBuilder(Vector<Reference<MeshData*> > meshData, Zone* zone, String name) :
Logger(name),
...
RecastNavMeshBuilder::RecastNavMeshBuilder(Vector<Reference<MeshData*> > meshData, Zone* zone, String name, dtNavMesh *mesh) :
Logger(name),
m_keepInterResults(false),
m_buildAll(true),
m_totalBuildTimeMs(0),
