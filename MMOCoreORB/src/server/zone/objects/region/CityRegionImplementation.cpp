...
//		builder = new RecastNavMeshBuilder(meshData, zone, filename, navmesh->getNavMesh());
//		radius = Vector3(20, 0, 20);
//		box = AABB(center-radius, center+radius);
//	} else {
//		builder = new RecastNavMeshBuilder(meshData, zone, filename);
//	}
